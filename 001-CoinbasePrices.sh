...
bit_price_gbp=$(curl -s -H "CB-Version: 2015-04-08" "https://api.coinbase.com/v2/prices/BTC-GBP/buy" | python -c "import sys, json; print(json.load(sys.stdin)['data']['amount'])")
...
eth_price=$(curl -s -H "CB-Version: 2015-04-08" "https://api.coinbase.com/v2/prices/ETH-GBP/buy" | python -c "import sys, json; print(json.load(sys.stdin)['data']['amount'])")
ltc_price=$(curl -s -H "CB-Version: 2015-04-08" "https://api.coinbase.com/v2/prices/LTC-GBP/buy" | python -c "import sys, json; print(json.load(sys.stdin)['data']['amount'])")
